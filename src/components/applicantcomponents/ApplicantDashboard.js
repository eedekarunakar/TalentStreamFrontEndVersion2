...
// import logoCompany1 from '../../images/dashboard/logo-company-1.png';
// import logoCompany2 from '../images/dashboard/logo-company-2.png';
// import logoCompany3 from '../images/dashboard/logo-company-3.png';
// import logoCompany4 from '../images/dashboard/logo-company-4.png';
...
const jobData = [
  {
    ...
    location: 'Diamond Trading Estates',
    daysAgo: '2 days ago',
    status: 'Seen',
  },
  {
   ...
   // logoSrc: logoCompany2,
    ...
    location: 'Sun West Condominiums',
    daysAgo: '2 days ago',
    status: 'Responded',
  },
  {
    ...
    location: 'Eclipse Estates',
    daysAgo: '2 days ago',
    status: 'Pending',
  },
  {
    id: 4,
    //logoSrc: logoCompany4,
    jobTitle: 'PHP Developer',
    location: 'Southeastern Properties',
    daysAgo: '2 days ago',
    status: 'Responded',
  },
];
              ...
              <div className="table-content">
                <div className="wrap-applicants table-responsive">
                  <table>
                    ...
                    <tbody>
                      {jobData.map((job) => (
                        <tr key={job.id} className="file-delete">
                          <td>
                            <div className="candidates-wrap flex2">
                              <div className="images">
                                {/* <img src={job.logoSrc} alt="" /> */}
                              </div>
                              <div className="content">
                                <h3>{job.jobTitle}</h3>
                                <div className="now-box flex2">
                                  <div className="map color-4">{job.location}</div>
                                  <div className="days">{job.daysAgo}</div>
                                </div>
                              </div>
                            </div>
                          </td>
                          <td>
                            <div className="status-wrap">
                              <div
                                className={`button-status style-bt ${
                                  job.status === 'Seen' ? 'style-2' : 'color-3'
                                }`}
                              >
                                {job.status}
                              </div>
                          ...
                          <td className="center">
                            <div className="title-day color-1">{job.daysAgo}</div>
                          </td>
                          <td className="center">
                            <div id={`items_${job.id}`} className="dropdown titles-dropdown">
                              ...
                              <ul>
                                <li>
                                  <span className="icon-eye more-ic"></span>
                                  <span>View Job</span>
                                </li>
                                <li className="remove-file">
                                  <span className="icon-trash more-ic "></span>
