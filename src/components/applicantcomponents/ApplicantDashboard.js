            ...
            <div className="wrap-icon widget-counter">
              ...
              <div className="box-icon wrap-counter flex">
                ...
                <div className="content">
                  <div className="count-dash counter-number" data-speed="2000" data-to="15"></div>
              ...
              <div className="box-icon wrap-counter flex">
                ...
                <div className="content">
                  <div className="count-dash counter-number" data-speed="2000" data-to="2068"></div>
              ...
              <div className="box-icon wrap-counter flex">
                ...
                <div className="content style3">
                  <div className="count-dash counter-number" data-speed="2000" data-to="21"></div>
              ...
              <div className="box-icon wrap-counter flex">
                ...
                <div className="content">
                  <div className="count-dash counter-number" data-speed="2000" data-to="320"></div>
